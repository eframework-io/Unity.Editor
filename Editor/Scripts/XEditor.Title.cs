    ...
    public partial class XEditor
    {
        ...
        public class Title : Event.Internal.OnEditorLoad, Event.Internal.OnPreferencesApply
        {
            ...
            internal static void SetTitle(object des)
            {
                ...
                if (!string.IsNullOrEmpty(preferencesLabel))
                {
                    descriptor.title += $" - {preferencesLabel}";
                }
            ...
            public static async Task Refresh()
            {
                ...
                try
                {
                    ...
                    preferencesLabel = $"[Preferences{preferencesDirty}: {preferencesName}/{XEnv.Channel}/{XEnv.Version}/{XEnv.Mode}/{XLog.Level()}]";
                    isRefreshing = true;
