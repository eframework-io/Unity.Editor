...
[![贡献人员](https://img.shields.io/github/contributors/eframework-io/Unity.Editor)](https://github.com/eframework-io/Unity.Editor/graphs/contributors)
[![月度提交](https://img.shields.io/github/commit-activity/m/eframework-io/Unity.Editor)](https://github.com/eframework-io/Unity.Editor/graphs/commit-activity)
[![最后提交](https://img.shields.io/github/last-commit/eframework-io/Unity.Editor)](https://github.com/eframework-io/Unity.Editor/commits/master)

[![活跃议题](https://img.shields.io/github/issues/eframework-io/Unity.Editor)](https://github.com/eframework-io/Unity.Editor/issues)
[![单元测试](https://github.com/eframework-io/Unity.Editor/actions/workflows/test.yml/badge.svg)](https://github.com/eframework-io/Unity.Editor/actions/workflows/test.yml)
[![版本发布](https://github.com/eframework-io/Unity.Editor/actions/workflows/publish.yml/badge.svg)](https://github.com/eframework-io/Unity.Editor/actions/workflows/publish.yml)
...
### 1. 环境准备
- 克隆项目仓库：`git clone https://github.com/eframework-io/Unity.Editor.git`
- 使用 `VS Code` 打开示例工程 `Samples~/Unity.Editor.code-workspace` 工作空间
...
- 发布版本：运行[版本发布](https://github.com/eframework-io/Unity.Editor/actions/workflows/publish.yml)工作流

## 问题反馈

### 1. 问题检索
- 查阅[议题](https://github.com/eframework-io/Unity.Editor/issues)避免重复
- 确认可以稳定重现
- 提供必要环境信息
